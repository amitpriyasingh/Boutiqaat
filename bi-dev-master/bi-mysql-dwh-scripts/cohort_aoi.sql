drop table if exists cohort_aoi;
create table cohort_aoi select customer_telephone, country,
...
COUNT(DISTINCT IF(order_date=first_order_date,customer_telephone,NULL)) m0,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 1 DAY) AND DATE_ADD(first_order_date , INTERVAL 30 DAY),customer_telephone,NULL)) m1,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 31 DAY) AND DATE_ADD(first_order_date , INTERVAL 60 DAY),customer_telephone,NULL)) m2,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 61 DAY) AND DATE_ADD(first_order_date , INTERVAL 90 DAY),customer_telephone,NULL)) m3,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 91 DAY) AND DATE_ADD(first_order_date , INTERVAL 120 DAY),customer_telephone,NULL)) m4,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 121 DAY) AND DATE_ADD(first_order_date , INTERVAL 150 DAY),customer_telephone,NULL)) m5,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 151 DAY) AND DATE_ADD(first_order_date , INTERVAL 180 DAY),customer_telephone,NULL)) m6,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 181 DAY) AND DATE_ADD(first_order_date , INTERVAL 210 DAY),customer_telephone,NULL)) m7,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 211 DAY) AND DATE_ADD(first_order_date , INTERVAL 240 DAY),customer_telephone,NULL)) m8,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 241 DAY) AND DATE_ADD(first_order_date , INTERVAL 270 DAY),customer_telephone,NULL)) m9,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 271 DAY) AND DATE_ADD(first_order_date , INTERVAL 300 DAY),customer_telephone,NULL)) m10,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 301 DAY) AND DATE_ADD(first_order_date , INTERVAL 330 DAY),customer_telephone,NULL)) m11,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 331 DAY) AND DATE_ADD(first_order_date , INTERVAL 360 DAY),customer_telephone,NULL)) m12,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 361 DAY) AND DATE_ADD(first_order_date , INTERVAL 390 DAY),customer_telephone,NULL)) m13,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 391 DAY) AND DATE_ADD(first_order_date , INTERVAL 420 DAY),customer_telephone,NULL)) m14,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 421 DAY) AND DATE_ADD(first_order_date , INTERVAL 450 DAY),customer_telephone,NULL)) m15,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 451 DAY) AND DATE_ADD(first_order_date , INTERVAL 480 DAY),customer_telephone,NULL)) m16,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 481 DAY) AND DATE_ADD(first_order_date , INTERVAL 510 DAY),customer_telephone,NULL)) m17,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 511 DAY) AND DATE_ADD(first_order_date , INTERVAL 540 DAY),customer_telephone,NULL)) m18,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 541 DAY) AND DATE_ADD(first_order_date , INTERVAL 570 DAY),customer_telephone,NULL)) m19,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 571 DAY) AND DATE_ADD(first_order_date , INTERVAL 600 DAY),customer_telephone,NULL)) m20,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 601 DAY) AND DATE_ADD(first_order_date , INTERVAL 630 DAY),customer_telephone,NULL)) m21,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 631 DAY) AND DATE_ADD(first_order_date , INTERVAL 660 DAY),customer_telephone,NULL)) m22,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 661 DAY) AND DATE_ADD(first_order_date , INTERVAL 690 DAY),customer_telephone,NULL)) m23,
COUNT(DISTINCT IF(order_date BETWEEN DATE_ADD(first_order_date , INTERVAL 691 DAY) AND DATE_ADD(first_order_date , INTERVAL 720 DAY),customer_telephone,NULL)) m24,
COUNT(DISTINCT IF(order_date > DATE_ADD(first_order_date , INTERVAL 720 DAY),customer_telephone,NULL)) m25andmore,
...
from (select a.customer_telephone, a.order_number order_id, a.gmv gmv, DATE(a.order_date) order_date, DATE(first_order_date) first_order_date, c_activity.country from (select *, sum(item_total) gmv from aoi where country <> 'Celebrities' group by order_number) a join c_activity on a.customer_telephone = c_activity.telephone_no ) e group by customer_telephone;
