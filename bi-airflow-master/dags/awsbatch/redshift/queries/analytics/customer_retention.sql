BEGIN;
DELETE FROM analytics.customer_retention WHERE 1=1;
INSERT INTO analytics.customer_retention
...
from 
(select distinct phone_no from aoi.order_items where lower(order_category) != 'celebrity') i
left join 
