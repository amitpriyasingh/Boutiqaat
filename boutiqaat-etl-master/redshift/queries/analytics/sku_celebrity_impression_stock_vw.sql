-- sandbox.sku_celebrity_impression_stock_vw source

CREATE OR REPLACE VIEW sandbox.sku_celebrity_impression_stock_vw
AS CREATE OR REPLACE VIEW sandbox.sku_celebrity_impression_stock_vw AS
